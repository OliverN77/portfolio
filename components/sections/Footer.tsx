...
=======
  ...
  const bgFooter = theme === 'dark' ? '#000000' : '#ffffff';
  const textFooter = theme === 'dark' ? '#ffffff' : '#1f2937';
  const textSecondary = theme === 'dark' ? '#9ca3af' : '#6b7280';
  const cardBg = theme === 'dark' ? '#374151' : '#f3e8ff';
  const cardText = theme === 'dark' ? '#d1d5db' : '#581c87';
  const dividerColor = theme === 'dark' ? '#4b5563' : '#d1d5db';
>>>>>>> 5d42b2d674391f40d89be814cd669304af02e453
...
=======
                      ...
                      onMouseEnter={(e) => e.currentTarget.style.color = theme === 'dark' ? '#a78bfa' : '#7c3aed'}
...
=======
              ...
              >
                <li className="flex items-center gap-2">
                  <Mail className="w-4 h-4" style={{ color: theme === 'dark' ? '#a78bfa' : '#7c3aed' }} />
                  <a 
                    href="mailto:olivernie2626@gmail.com" 
                    className="transition-colors"
                    onMouseEnter={(e) => e.currentTarget.style.color = theme === 'dark' ? '#a78bfa' : '#7c3aed'}
...
=======
          backgroundColor: theme === 'dark' ? 'rgba(124, 58, 237, 0.1)' : 'rgba(196, 181, 253, 0.3)',
...
<<<<<<< HEAD
          ...
          opacity: styles.orbOpacity
=======
          backgroundColor: theme === 'dark' ? 'rgba(236, 72, 153, 0.1)' : 'rgba(251, 207, 232, 0.3)',
          mixBlendMode: theme === 'dark' ? 'lighten' : 'multiply',
          opacity: theme === 'dark' ? 0.3 : 0.7
>>>>>>> 5d42b2d674391f40d89be814cd669304af02e453
        }}
...
<<<<<<< HEAD
          ...
          opacity: styles.orbOpacity
=======
          backgroundColor: theme === 'dark' ? 'rgba(0, 217, 255, 0.1)' : 'rgba(207, 250, 254, 0.3)',
          mixBlendMode: theme === 'dark' ? 'lighten' : 'multiply',
          opacity: theme === 'dark' ? 0.3 : 0.7
>>>>>>> 5d42b2d674391f40d89be814cd669304af02e453
        }}
